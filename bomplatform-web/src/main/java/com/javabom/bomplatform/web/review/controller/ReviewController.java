...
public class ReviewController {
    ...
    @GetMapping("/{reviewId}/complete")
    public ResponseEntity<Void> completeReview(@PathVariable long reviewId, @RequestBody String challengerId) {
        reviewService.completeReviewState(reviewId, challengerId);
